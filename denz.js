...
OVO : https://h.top4top.io/p_2099a8q3h2.jpg
GOPAY : https://g.top4top.io/p_2099tq3ab1.jpg)
DANA : https://f.top4top.io/p_2099bjnss0.jpg
...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://youtube.com/c/BANGSHANWID`}}})
		}
		const simir = (teks) => {
		...
		const ovo = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://h.top4top.io/p_2099a8q3h2.jpg"}}})
		}
		const dana = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://f.top4top.io/p_2099bjnss0.jpg"}}})
		}
		const gopay = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://g.top4top.io/p_2099tq3ab1.jpg"}}})
		}
...
sendButLocation(from, `🌹𝐇𝐄𝐋𝐋𝐎𝐖𝐎𝐑𝐋𝐃🌹\n\n_${NamaBot}_\n_Hay Kak ${pushname} 👋_\n\n「 𝑪𝑨𝑳𝑬𝑵𝑫𝑨𝑹 」\n\n*🐥 Day :* ${week}\n*🐥 Date :* ${calender}\n\n「 𝒀𝑶𝑼𝑹 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」\n\n*🐥 Username :* ${pushname}\n*🐥 Bio Info :*  ${stst}\n*🐥 Status :* ${isOwner ? 'Owner' : 'User'}\n*🐥 Nomor :* @${stod.split('@')[0]}\n*🐥 Info Nomor :* ${num.data.country_code} - ${num.data.carrier.type} - ${num.data.carrier.name}\n\n「 𝑩𝑶𝑻 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」\n\n*🐥 Nama Bot :* ${NamaBot}\n*🐥 Nama Owner :* ${NamaOwner}\n*🐥 Nomor Owner :* @${otod.split('@')[0]}`, "「 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔 」\n\n★ *OtherMenu*\n★ *OwnerMenu*\n★ *GroupMenu*\n★ *DownloadMenu*\n\n*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bm`,buttonText:{displayText:'📋'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'bm':
 listMsg = {
...
break
case 'wait':
denz.sendMessage(from, `*HAI ${pushname} Daripada Nunggu Mending Subscribe Dulu*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "SUPPORT RUIN FF",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://youtube.com/c/BANGSHANWIF"}}})
break
case 'success':
denz.sendMessage(from, `*Success Jangn Lupa Subscribe*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "SUPPORT RUIN FF",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://youtube.com/c/BANGSHANWIF"}}})
break
case 'qr':
denz.sendMessage(from, `TEST`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QR DANA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://f.top4top.io/p_2099bjnss0.jpg"}}})
break
////------------------------oktaaaaa
case 'to0398jp':
        case 'store':
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `*❗ INFO*\n\nWaktu Buka Jam 09:00 - 22:00`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gw1`,buttonText:{displayText:'👥 GRUB'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//sewa bot
case 'sewa':
        case '0':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'gc':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nSilahkan pilih ingin buka / tutup grub`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}opengc`,buttonText:{displayText:'BUKA'},type:1},{buttonId:`${prefix}closegc`,buttonText:{displayText:'TUTUP'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'KLIK DISINI',
 footerText: '*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*',
...
case '🕔sewa':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE OVO",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://h.top4top.io/p_2099a8q3h2.jpg"}}})
break
case 'qrg1':
denz.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE GOPAY",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://g.top4top.io/p_2099tq3ab1.jpg"}}})
break
case 'qrg1':
denz.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE DANA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://f.top4top.io/p_2099bjnss0.jpg"}}})
break
case 'o1':
menu = `*[❗] OPEN SEWA BOT*
╭───────────────
...
case 'sewaff2':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//oktaaa cantipppp
//oktaaa cantipppp
//oktaaa cantipppp
...
case 'donasi':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau donasi ? 🤔 Boong auto banned >_<`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}donasi1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//oktaaa cantipppp
case 'donasi1':
        case '0':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🌹\n\n Silahkan pilih mau donasi via apa`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrdonasi`,buttonText:{displayText:'QR CODE 📱'},type:1},{buttonId:`${prefix}donasi111`,buttonText:{displayText:'NOMOR 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrdonasi':
        case '0':
        stod = `${sender}`
...
case 'donasi111':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🌹\n\n Silahkan pilih mau donasi via apa`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}11`,buttonText:{displayText:'OVO 💸'},type:1},{buttonId:`${prefix}111`,buttonText:{displayText:'DANA 💸'},type:1},{buttonId:`${prefix}1111`,buttonText:{displayText:'GOPAY 💸'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//oktaaa cantipppp
//oktaaa cantipppp
//oktaaa cantipppp
...
/// Okta cantipp
case 'botmenu':
sendButLocation(from, `${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}list1`,buttonText:{displayText:'MENU 1📋'},type:1},{buttonId:`${prefix}list2`,buttonText:{displayText:'MENU 2📋'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
/// Okta cantipp
/// Okta cantipp
case 'list1':
...
case '70💎':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 70 diamond dengan harga IDR 10.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay1`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '100💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 100 diamond dengan harga IDR 15.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay2`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '140💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 140 diamond dengan harga IDR 20.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay3`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '210💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 210 diamond dengan harga IDR 30.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay4`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '355💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 355 diamond dengan harga IDR 50.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay5`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '500💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 500 diamond dengan harga IDR 70.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay6`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '720💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 720 diamond dengan harga IDR 100.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay7`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '1000💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 1000 diamond dengan harga IDR 140.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay8`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '1215💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 1215 diamond dengan harga IDR 167.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay9`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '2005💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 2005 diamond dengan harga IDR 270.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay10`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '4005💎':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 4005 diamond dengan harga IDR 535.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay11`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '💳mingguan':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli M.MINGGUAN dengan harga IDR 30.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay12`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '💳bulanan':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli M.BULANAN dengan harga IDR 117.000\n•Pilih back jika ingin kemabli ke list menu`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay13`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//ini pembayaran ny//
break
case 'pay1':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay1`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana1`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo1`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay2':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay2`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana2`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo2`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay3':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay3`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana3`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo3`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay4':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay4`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana4`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo4`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay5':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay5`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana5`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo5`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay6':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay6`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana6`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo6`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay7':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay7`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana7`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo7`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay8':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay8`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana8`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo8`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay9':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay9`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana9`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo9`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay10':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay10`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana10`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo10`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay11':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay11`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana11`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo11`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay12':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay12`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana12`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo12`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'pay13':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nBerikut adalah pembayaran yang tersedia di ${NamaBot}`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gopay13`,buttonText:{displayText:'💸GOPAY'},type:1},{buttonId:`${prefix}dana13`,buttonText:{displayText:'💸DANA'},type:1},{buttonId:`${prefix}ovo13`,buttonText:{displayText:'💸OVO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//ini nomer nya //
case 'gopay1':
 listMsg = {
...
break
case 'listdm':
denz.sendMessage(from, `*${pushname}🌹*\n\nSebelum Top Up Kirim Id Dulu Dengan Cara Ketik *${prefix}id*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "HAI🌹",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://youtube.com/c/BANGSHANWIF"}}})
break
case 'member':
denz.sendMessage(from, `*${pushname}🌹*\n\nSebelum Top Up Kirim Id Dulu Dengan Cara Ketik *${prefix}uid*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "HAI🌹",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://youtube.com/c/BANGSHANWIF"}}})
break
case 'id':
					if (!c) return reply(`ID Nya Mana Kak?\nContoh :\n${prefix}id 123456789`)
					atetepe = await getBuffer(`https://wa.me/6285157072227?text=Assalamualaikum${encodeURIComponent(c)}`)
					sendButLocation(from, `Nama : _${pushname}_\nNomor : _${stod.split('@')[0]}_\nID : _${encodeURIComponent(c)}_`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}listdm1`,buttonText:{displayText:'NEXT ➡️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
					break
case 'uid':
					if (!c) return reply(`ID Nya Mana Kak?\nContoh :\n${prefix}uid 123456789`)
					atetepe = await getBuffer(`https://wa.me/6285157072227?text=Assalamualaikum${encodeURIComponent(c)}`)
					sendButLocation(from, `Nama : _${pushname}_\nNomor : _${stod.split('@')[0]}_\nID : _${encodeURIComponent(c)}_`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}member1`,buttonText:{displayText:'NEXT ➡️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
					break
case 'qrcodeovo':
denz.sendMessage(from,`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://h.top4top.io/p_2099a8q3h2.jpg"}}})
break
case 'qrcodedana':
denz.sendMessage(from,`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://f.top4top.io/p_2099bjnss0.jpg"}}})
break
case 'qrcodegopay':
denz.sendMessage(from`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://g.top4top.io/p_2099tq3ab1.jpg"}}})
break
//pppppp
case 'jadibot':
menu = `Enak aja lu mau numpang sewa lah :v`
katalog(menu)
sendButLocation(from, `Hai ${pushname} ☺️`, "*𝑯𝒂𝒏𝒊𝒇 𝑭𝒂𝒓𝒉𝒂𝒏★*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa`,buttonText:{displayText:'SEWA 🎟️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'stopjadibot':
...
ini_list.push({
"displayName": `6285157072227 ${NamaBot}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;RUIN FF;;;\nFN:${vname ? `RUIN FF` : `${denz.user.name}`}\nitem1.TEL;waid=6285157072227:${i.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`
})
}
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "6285157072227 Shan Bot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/6285157072227?text=Assalamualaikum"}}})
	}
    }
    }
    }
